...
'''
Process managers for txchangecoindd, txchangecoin-wallet-cli and txchangecoin-wallet-rpc
'''
...
class TxchangecoindManager(ProcessManager):
    def __init__(self, resources_path, log_level=1, block_sync_size=20, limit_rate_up=2048, limit_rate_down=8192):
        ...
        super(TxchangecoindManager, self).__init__(exec_path, proc_args, "txchangecoind")
...
class WalletRPCManager(ProcessManager):
    def __init__(self, resources_path, wallet_dir_path, app, log_level=1):
        ...
        wallet_log_dir_path = os.path.abspath(os.path.join(wallet_dir_path, ".." , "logs", "txchangecoin-wallet-rpc-bin.log"))
        exec_path = u'%s/bin/txchangecoin-wallet-rpc' % resources_path
        ...
        super(WalletRPCManager, self).__init__(exec_path, wallet_rpc_args, "txchangecoin-wallet-rpc")
